        ...
        <table>
          <tr>
            ...
            <td><a type="button" style="margin-right: 10px; margin-bottom: 25px;" class="btn btn-info btn-md"
              href="../../../mesin/cetak-daftar-ulang.php?nik=<?php echo $d['nik']; ?>">Cetak Bukti Daftar Ulang</a></td>
            <td><a type="button" style="margin-right: 10px; margin-bottom: 25px;" class="btn btn-info btn-md"
              href="../../../mesin/cetak-form.php?nik=<?php echo $d['nik']; ?>">Cetak Bukti Pakta Integritas</a></td>
