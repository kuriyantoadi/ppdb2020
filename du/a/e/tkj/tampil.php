        ...
        <table>
          <tr>
            ...
            <td><a type="button" style="margin-right: 10px; margin-bottom: 25px;" class="btn btn-info btn-md"
              href="../../../tkj/cetak-daftar-ulang.php?nik=<?php echo $d['nik']; ?>">Cetak Bukti Daftar Ulang</a></td>
            <td><a type="button" style="margin-right: 10px; margin-bottom: 25px;" class="btn btn-info btn-md"
              href="../../../tkj/cetak-form.php?nik=<?php echo $d['nik']; ?>">Cetak Bukti Pakta Integritas</a></td>
          ...
          <form class="" action="proses.php" method="post">
            ...
            <tr>
              ...
              <td>
                ...
                <embed src="../../../tkj/file/<?php echo $d['pdf_swa_fakta']; ?>" type="application/pdf" width="100%" height="500px">
              </td>
            </tr>
            <tr>
              <td>Pakta Integritas</td>
              <td>
                <embed src="../../../tkj/file/<?php echo $d['pdf_fakta']; ?>" type="application/pdf" width="100%" height="500px">
              </td>
            </tr>
            <tr>
              <td>SKL</td>
              <td>
                <embed src="../../../tkj/file/<?php echo $d['pdf_skl']; ?>" type="application/pdf" width="100%" height="500px">
              </td>
            </tr>
            <tr>
              <td>Akta Kelahiran</td>
              <td>
                <embed src="../../../tkj/file/<?php echo $d['pdf_akta']; ?>" type="application/pdf" width="100%" height="500px">
              </td>
            </tr>
            <tr>
              <td>Kartu Keluarga</td>
              <td>
                <embed src="../../../tkj/file/<?php echo $d['pdf_kk']; ?>" type="application/pdf" width="100%" height="500px">
              </td>
            </tr>
            <tr>
              <td>Photo Background Merah</td>
              <td>
                <embed src="../../../tkj/file/<?php echo $d['pdf_photo']; ?>" type="application/pdf" width="100%" height="500px">
              </td>
            </tr>
            <tr>
              <td>Surat Dokter</td>
              <td>
                <embed src="../../../tkj/file/<?php echo $d['pdf_surat_dokter']; ?>" type="application/pdf" width="100%" height="500px">
              </td>
            </tr>
            <tr>
