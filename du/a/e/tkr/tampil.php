        ...
        <table>
          <tr>
            ...
            <td><a type="button" style="margin-right: 10px; margin-bottom: 25px;" class="btn btn-info btn-md"
              href="../../../tkr/cetak-daftar-ulang.php?nik=<?php echo $d['nik']; ?>">Cetak Bukti Daftar Ulang</a></td>
            <td><a type="button" style="margin-right: 10px; margin-bottom: 25px;" class="btn btn-info btn-md"
              href="../../../tkr/cetak-form.php?nik=<?php echo $d['nik']; ?>">Cetak Bukti Pakta Integritas</a></td>
