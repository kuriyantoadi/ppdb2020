  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <center>
          <h4><b>Daftar Siswa Daftar Ulang</b></h4>
        </center>
        <center>
    ...
    <div class='alert alert-info' role='alert'>
      <center>Data akan Di verifikasi oleh Operator
    </div>
    ...
    <table class="table table-bordered table-hover" id="domainsTable">
      ...
      $data = mysqli_query($koneksi, "SELECT
        ...
        kondisi,
        catatan
        from du_otkp where kompetensi_keahlian in ('Otomatisasi dan Tata Kelola Perkantoran') LIMIT $mulai, $halperpage ");
      $no = $mulai+1;
