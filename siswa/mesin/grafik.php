    ...
    var myChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          <?php
          //seluruh siswa
          $diagram_semua = mysqli_query($koneksi, "SELECT tgl_pendaftaran FROM f_siswa_mesin ");
          echo mysqli_num_rows($diagram_semua);
          ?>,
          <?php
          //siswa belum seleksi
          $diagram_blm = mysqli_query($koneksi, "SELECT tgl_pendaftaran FROM f_siswa_mesin WHERE tgl_pendaftaran = ''");
          ...
          <?php
          //siswa sudah seleksi
          $diagram_periksa = mysqli_query($koneksi, "SELECT tgl_pendaftaran FROM f_siswa_mesin WHERE kondisi = ''");
